...
from .views import CreateUserView, UpdateUserView, DeleteUserView, DailyIntakeListView, FoodDetailView, PaginatedFoodListView, WeightLogListView, get_nutrition_data
from . import views
